...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_editor_table_vue__ = __webpack_require__(16);
...
const vm = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  ...
  methods: {
    ...
    datasourceUpdater: async function (datasource) {
      ...
      return __WEBPACK_IMPORTED_MODULE_1__api__["H" /* updateDatasource */](clean);
    },
    ...
    handleFileUpload: async function (event, datasourceName, updateType) {
      ...
      reader.onload = async function (e) {
        ...
        const response = await __WEBPACK_IMPORTED_MODULE_1__api__["P" /* uploadData */](params);
