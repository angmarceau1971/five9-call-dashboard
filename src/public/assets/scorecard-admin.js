...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_editor_table_vue__ = __webpack_require__(14);
...
const vm = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a({
  ...
  methods: {
    ...
    goalRemover: function (goal) {
      return __WEBPACK_IMPORTED_MODULE_0__api_js__["a" /* deleteGoal */](goal);
    },
    // Link functions
    ...
    linkRemover: function (link) {
      return __WEBPACK_IMPORTED_MODULE_0__api_js__["b" /* deleteLink */](link);
    }
  }
});
