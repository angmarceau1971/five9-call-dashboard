...
const vm = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  ...
  methods: {
    ...
    datasourceUpdater: async function (datasource) {
      ...
      return __WEBPACK_IMPORTED_MODULE_1__api__["t" /* updateDatasource */](clean);
    },
    datasourceLoader: async function () {
      let datasources = await __WEBPACK_IMPORTED_MODULE_1__api__["f" /* getDatasources */]();
    ...
    handleFileUpload: async function (event, datasourceName) {
      ...
      reader.onload = async function (e) {
        ...
        const response = await __WEBPACK_IMPORTED_MODULE_1__api__["z" /* uploadData */](params);
