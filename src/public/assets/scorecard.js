...
var _isPlaceholder = /*#__PURE__*/__webpack_require__(135);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_widget_base_vue__ = __webpack_require__(352);
var disposed = false
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_data_table_vue__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_48d3d2c4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_data_table_vue__ = __webpack_require__(358);
var disposed = false
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_line_graph_vue__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_21d5040e_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_line_graph_vue__ = __webpack_require__(359);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
function sortOrder(a, b, event, dropId, el) {
  var left = function left(x) {
    return el(x).offsetLeft;
  };

  var top = function top(x) {
    return el(x).offsetTop;
  };

  var bottom = function bottom(x) {
    return top(x) + el(x).clientHeight;
...
var _has = /*#__PURE__*/__webpack_require__(97);
...
var _curry1 = /*#__PURE__*/__webpack_require__(52);
...
var _lineGraph = _interopRequireDefault(__webpack_require__(133));

var _dataTable = _interopRequireDefault(__webpack_require__(96));

var _dashboard = _interopRequireDefault(__webpack_require__(360));

var _scorecardFormat = __webpack_require__(67);

var _local_settings = __webpack_require__(376);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } } function _next(value) { step("next", value); } function _throw(err) { step("throw", err); } _next(); }); }; }

var isEmpty = __webpack_require__(377);
...
var store = new Vuex.Store({
  ...
  getters: {
    field: function field(state) {
      return function (fieldName) {
        return state.fields.find(function (f) {
  ...
  mutations: {
    toggleEditMode: function toggleEditMode(state) {
...
var vm = new Vue({
  ...
  methods: {
    postAcd: function postAcd() {
      var url = 'statistics';
      var apiURL = _local_settings.API_URL + url; // defined in api_url.js
    ...
    importLayout: function importLayout(event) {
    ...
    updateLayout: function updateLayout(newLayout) {
      Object.assign(this.layout, newLayout);
    },
    updateCard: function updateCard(cardId, newCard) {
      var oldCardIndex = this.layout.cards.findIndex(function (card) {
        return card.id == cardId;
      });
      var oldCard = this.layout.cards[oldCardIndex]; // Create a new card object that has all properties from the
      // new card and the old one (to include properties that aren't
      // defined in `newCard`)

      var newCardComplete = Object.assign({}, oldCard, newCard); // Use `Vue.set` to trigger reactivity
      // https://vuejs.org/v2/guide/reactivity.html#Change-Detection-Caveats

      Vue.set(this.layout.cards, oldCardIndex, newCardComplete);
    },
    deleteCard: function deleteCard(cardId) {
      var cardIndex = this.layout.cards.findIndex(function (card) {
        return card.id == cardId;
      });
     ...
     * @return
     */
    modifyWidget: function modifyWidget(newWidget, widgetId, cardId) {
      var card = this.layout.cards.find(function (c) {
        return c.id == cardId;
      });
      var oldWidgetIndex = card.widgets.findIndex(function (w) {
        return w.id == widgetId;
      });
      var oldWidget = card.widgets[oldWidgetIndex];

      if (isEmpty(newWidget)) {
        Vue.delete(card.widgets, oldWidgetIndex);
      } else {
        // see updateCard function for explanation
        var newWidgetComplete = Object.assign({}, oldWidget, newWidget);
...
var update = __webpack_require__(51)("7034c06e", content, false);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__data_table_vue__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__widget_base_vue__ = __webpack_require__(68);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  props,
  components: {
    'data-table': __WEBPACK_IMPORTED_MODULE_0__data_table_vue__["default"]
  },
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(51)("5e100a93", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__data_table_row_vue__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__widget_base_vue__ = __webpack_require__(68);
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_data_table_row_vue__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_067c065e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_data_table_row_vue__ = __webpack_require__(351);
var disposed = false
var normalizeComponent = __webpack_require__(29)
/* script */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__javascript_scorecard_format_js__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__javascript_scorecard_format_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__javascript_scorecard_format_js__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    formatted: function (val, fieldName) {
      let res = Object(__WEBPACK_IMPORTED_MODULE_0__javascript_scorecard_format_js__["formatValue"])(val, this.$store.getters.field(fieldName));
      return res;
    }
  }
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_vue__ = __webpack_require__(353);
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_editor_vue__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_a38dd874_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_editor_vue__ = __webpack_require__(357);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(51)("f189e898", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_dashboard_vue__ = __webpack_require__(361);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_c21f7d6a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_dashboard_vue__ = __webpack_require__(375);
var disposed = false
var normalizeComponent = __webpack_require__(29)
/* script */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__card_editor_vue__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__drag_n_drop_sort_js__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__drag_n_drop_sort_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__drag_n_drop_sort_js__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    dropHandler: function (event) {
      ...
      newLayout.cards.sort((a, b) => Object(__WEBPACK_IMPORTED_MODULE_2__drag_n_drop_sort_js__["sortOrder"])(a, b, event, id, el)); // Update the layoutOrder property for each card
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_card_vue__ = __webpack_require__(365);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3bec8029_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_card_vue__ = __webpack_require__(369);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(51)("4911ebf4", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__widget_base_vue__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_table_vue__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__line_graph_vue__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__single_value_vue__ = __webpack_require__(366);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__javascript_scorecard_format__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__javascript_scorecard_format___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__javascript_scorecard_format__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__drag_n_drop_sort_js__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__drag_n_drop_sort_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__drag_n_drop_sort_js__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    ...
    'data-table': __WEBPACK_IMPORTED_MODULE_1__data_table_vue__["default"],
    'line-graph': __WEBPACK_IMPORTED_MODULE_2__line_graph_vue__["default"]
  },
  data: function () {
    return {
      highlightedDate: null,
  ...
  methods: {
    ...
    dropWidgetHandler: function (event) {
      ...
      newWidgets.sort((a, b) => Object(__WEBPACK_IMPORTED_MODULE_5__drag_n_drop_sort_js__["sortOrder"])(a, b, event, dragData.widgetId, el)); // assign a layout order based on sort
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_single_value_vue__ = __webpack_require__(367);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4ae719c5_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_single_value_vue__ = __webpack_require__(368);
var disposed = false
var normalizeComponent = __webpack_require__(29)
/* script */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__widget_base_vue__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__javascript_scorecard_format__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__javascript_scorecard_format___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__javascript_scorecard_format__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    ...
    formatted: function () {
      return Object(__WEBPACK_IMPORTED_MODULE_1__javascript_scorecard_format__["formatValue"])(this.value, this.field);
    }
  },
  methods: {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_card_editor_vue__ = __webpack_require__(373);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9d3c827e_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_card_editor_vue__ = __webpack_require__(374);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(51)("419b5586", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var empty = /*#__PURE__*/__webpack_require__(378);

var equals = /*#__PURE__*/__webpack_require__(382);
...
var _isArguments = /*#__PURE__*/__webpack_require__(136);

var _isArray = /*#__PURE__*/__webpack_require__(379);

var _isObject = /*#__PURE__*/__webpack_require__(380);

var _isString = /*#__PURE__*/__webpack_require__(381);
...
var _curry2 = /*#__PURE__*/__webpack_require__(137);

var _equals = /*#__PURE__*/__webpack_require__(383);
...
var _arrayFromIterator = /*#__PURE__*/__webpack_require__(384);

var _containsWith = /*#__PURE__*/__webpack_require__(385);

var _functionName = /*#__PURE__*/__webpack_require__(386);

var _has = /*#__PURE__*/__webpack_require__(97);

var identical = /*#__PURE__*/__webpack_require__(387);

var keys = /*#__PURE__*/__webpack_require__(388);

var type = /*#__PURE__*/__webpack_require__(389);
